...
test1 <- c("female", "agegrp", "white") # "black" , "white", "hisp", "asian", "asian_nhpi", "othrace", "mhighgd_bin", "rural", "mixur", "mhhinco")
...
source("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/R/ebw.")
