...
test1 <- c("female", "agegrp", "white","black", "hisp", "asian", "asian_nhpi", "othrace", "mhighgd_bin", "rural", "mixur", "mhhinco")
random = sample(test1,5)
random
...
#saving the output in nice format
tests <- c("ACE Vs. Neither", "ACE + OCS Vs. ACE only")
