...
dat <- read_sas("./SAS Data Management Files/Data/finalvar_03232023.sas7bdat")
summary(dat)
summary(dat$w)
summary(dat$bneedin)
summary(dat$mloveaf)
...
anyACE_list  <- c('commstr',  'ecstand',  'bneedin',  'mloveaf',  'mphysab',
                  ...
                  'divorce',  'physabu',  'subsuse',  'mentill','discrim', 'discrim_reason', 'discrim_ethn',
                  'discrim_race', 'discrim_raceethn','discrim_sexualorient')
...
saveRDS(dat,"./Data for Analysis/data_for_regTree_03312023.Rds")
