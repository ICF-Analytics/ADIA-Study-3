...
# - No combination of ACE and OCS for present health classical tree
...
dat <-
  ...
  mutate(ace_ocs =
           case_when(
               anyACE_T == 1 & !(mphysab == 1 | ecstand == 1 | msubstu == 1) ~ "ACE"
             , anyACE_T == 1 & (mphysab == 1 | ecstand == 1 | msubstu == 1) ~ "ACE + OCS"
             , anyACE_T == 0 & (mphysab == 1 | ecstand == 1 | msubstu == 1) ~ "OCS"
             , anyACE_T == 0 & !(mphysab == 1 | ecstand == 1 | msubstu == 1) ~ "None"
           )
