...
dat <-
  ...
  mutate(ace_ocs =
           case_when(
               anyACE_T == 1 & !(loveaff == 1 | mphysab == 1 | commstr == 1 | msubstu == 1 | bneedin == 1) ~ "ACE"
             , anyACE_T == 1 &  (loveaff == 1 | mphysab == 1 | commstr == 1 | msubstu == 1 | bneedin == 1) ~ "ACE + OCS"
             , anyACE_T == 0 &  (loveaff == 1 | mphysab == 1 | commstr == 1 | msubstu == 1 | bneedin == 1) ~ "OCS"
             , anyACE_T == 0 & !(loveaff == 1 | mphysab == 1 | commstr == 1 | msubstu == 1 | bneedin == 1) ~ "None"
           )
