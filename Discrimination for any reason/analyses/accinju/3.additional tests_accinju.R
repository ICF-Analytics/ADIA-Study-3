...
dat <-
  ...
  mutate(ace_ocs =
           case_when(
               anyACE_T == 1 & !(loveaff == 1 | ecstand == 1 | bneedin == 1 | commstr== 1 | msubstu== 1 |  mmental== 1 | mloveaf== 1 | mphysab== 1) ~ "ACE"
             , anyACE_T == 1 &  (loveaff == 1 | ecstand == 1 | bneedin == 1 | commstr== 1 | msubstu== 1 |  mmental== 1 | mloveaf== 1 | mphysab== 1) ~ "ACE + OCS"
             , anyACE_T == 0 &  (loveaff == 1 | ecstand == 1 | bneedin == 1 | commstr== 1 | msubstu== 1 |  mmental== 1 | mloveaf== 1 | mphysab== 1) ~ "OCS"
             , anyACE_T == 0 & !(loveaff == 1 | ecstand == 1 | bneedin == 1 | commstr== 1 | msubstu== 1 |  mmental== 1 | mloveaf== 1 | mphysab== 1) ~ "None"
           )
...
data.frame(all) %>%
  gt %>%
  tab_header(title = "Race/Ethnicity Composition and Outcome Score") %>%
