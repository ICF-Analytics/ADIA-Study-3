...
dat <- readRDS("./01_Data for Analysis/data_for_regTree_05302023.Rds") # 841 observations (Study 3 only)
dim(dat)
...
png(
  paste0("./05_Regression Tree Output/", out, "/tree.plot.causal", i, "_Study 3_labelsupdated.png"),
