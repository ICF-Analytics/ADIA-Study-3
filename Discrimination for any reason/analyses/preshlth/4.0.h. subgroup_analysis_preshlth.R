...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/pred_by_hisp.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/test_by_hisp.html"))
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/pred_by_hisp_female.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/test_by_hisp_female.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/pred_by_hisp_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/test_by_hisp_dr.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/pred_by_hisp_female_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/test_by_hisp_female_dr.html"))
