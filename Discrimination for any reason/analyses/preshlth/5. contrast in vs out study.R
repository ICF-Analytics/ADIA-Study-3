...
dat0 <- haven:::read_sas("/Users/Lucas/Documents/GitHub/ADIA-Study-3/data/finalvar_03232023.sas7bdat")
...
source("/Users/Lucas/Documents/GitHub/ADIA-Study-3/R/ebw.r")
...
left_join(tb_r, tb_w, by = "var", suffix = c(".raw", ".weighted")) %>%
  ...
  gtsave(paste0("output/", out, "/S3vsS1/raw_weighted.html"))
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("output/", out, "/S3vsS1/pred_by_discrimination.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("output/", out, "/S3vsS1/test_by_discrimination.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("output/", out, "/S3vsS1/pred_by_discrimination_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("output/", out, "/S3vsS1/test_by_discrimination_dr.html"))