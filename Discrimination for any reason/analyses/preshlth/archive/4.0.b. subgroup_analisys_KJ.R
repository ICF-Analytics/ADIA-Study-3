############# for testing 'Black vs white' AND 'black female' vs. 'nonblack male' #############
rm(list=ls(all=TRUE))
library(tidyverse)
library(survey)
library(gt)
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/subgroup/", out, "_pred_by_black.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/subgroup/", out, "_test_by_black.html"))
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/subgroup/", out, "_pred_by_black_female.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/subgroup/", out, "_test_by_black_female.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/subgroup/", out, "_pred_by_black_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/subgroup/", out, "_test_by_black_dr.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/subgroup/", out, "_pred_by_black_female_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/subgroup/", out, "_test_by_black_female_dr.html"))
