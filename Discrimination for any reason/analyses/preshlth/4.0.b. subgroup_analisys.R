...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("output/", out, "/subgroup/pred_by_black.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("output/", out, "/subgroup/test_by_black.html"))
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("output/", out, "/subgroup/pred_by_black_female.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("output/", out, "/subgroup/test_by_black_female.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("output/", out, "/subgroup/pred_by_black_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("output/", out, "/subgroup/test_by_black_dr.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("output/", out, "/subgroup/pred_by_black_female_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("output/", out, "/subgroup/test_by_black_female_dr.html"))
