...
file_name <- paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/NLS.tree_", out, ".Rds")
...
tb %>%
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/", out, "/predicted_cls", out, i, "_Study 3.html"))
...
tb %>%
  ...
  #),  cells_stubhead()) %>% # added to save p-value 
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/", out, "/predicted_cau", out, i, "_Study 3.html"))
