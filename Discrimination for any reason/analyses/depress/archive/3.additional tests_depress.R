...
left_join(tb_r, tb_w, by = "var", suffix = c(".raw", ".weighted")) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/raw_weighted_cls_", out, i, ".html"))
...
data.frame(Contrast = tests,
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/test0_cls_", out, i, ".html"))
...
left_join(freq, data.frame(Group = grp, pred0, confint(pred0)), by = "Group") %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/pred0_cls_", out, i, ".html"))
...
data.frame(Contrast = tests,
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/test_dr_cls_", out, i, ".html"))
...
left_join(freq, data.frame(Group = grp, pred_dr, confint(pred_dr)), by = "Group") %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/pred_dr_cls_", out, i, ".html"))
...
data.frame(all) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/supplemental_race_cls_", out,".html"))
...
left_join(tb_r, tb_w, by = "var", suffix = c(".raw", ".weighted")) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/raw_weighted_cau_", out, i, ".html"))
...
data.frame(Contrast = tests,
  ...
  #gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/test0", out, i, ".html"))
  gtsave(paste0("./05_Regression Tree Output/", out, "/test0_cau_", out, i, ".html"))
...
left_join(freq, data.frame(Group = grp, pred0, confint(pred0)), by = "Group") %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/pred0_cau_", out, i, ".html"))
...
data.frame(Contrast = tests,
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/test_dr_cau_", out, i, ".html"))
...
left_join(freq, data.frame(Group = grp, pred_dr, confint(pred_dr)), by = "Group") %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/pred_dr_cau_", out, i, ".html"))
...
data.frame(all) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/supplemental_race_cau_", out,".html"))
