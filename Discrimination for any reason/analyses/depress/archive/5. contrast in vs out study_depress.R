...
dat0 <- haven:::read_sas("./03_SAS Data Management Files/Data/finalvar_03232023.sas7bdat")
...
left_join(tb_r, tb_w, by = "var", suffix = c(".raw", ".weighted")) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out ,"/raw_weighted.html"))
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out ,"/pred_by_discrimination.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/", out ,"/test_by_discrimination.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out ,"/pred_by_discrimination_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/", out ,"/test_by_discrimination_dr.html"))
