...
left_join(tb_r, tb_w, by = "var", suffix = c(".raw", ".weighted")) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_raw_weighted.html"))

dat0$y <- unlist(dat0[, out])

#=======================================================================
### 2.- Quick comparison  Study 3 sample vs rest for reference
#=======================================================================
...
fit00   <- svyglm(y ~ ace_ocs, design = sdw0, family = gaussian)
...
#=======================================================================
###3.- Formal comparison Study 3 sample vs rest
#=======================================================================
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_pred_by_discrimination.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_test_by_discrimination.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_pred_by_discrimination_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_test_by_discrimination_dr.html"))
