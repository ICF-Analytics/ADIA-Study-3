...
## this tests the contrasts between Black and non-Hispanic White in the classical model
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_pred_by_black.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_test_by_black.html"))
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_pred_by_black_female.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_test_by_black_female.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_pred_by_black_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_test_by_black_dr.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_pred_by_black_female_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cls_test_by_black_female_dr.html"))
