...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_pred_by_miniority.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_test_by_miniority.html"))
...
merge(est, n[, -ncol(n)]) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_pred_by_female.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_test_by_female.html"))
#-----------------------------------------------------------
###' c. - Minority & Female
#-----------------------------------------------------------
...
merge(est, n[, -ncol(n)]) %>%
  gt %>%
  tab_header(title = "Predicted values by minority and female") %>%
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_pred_by_miniority_female.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_test_by_minority_female.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_pred_by_miniority_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_test_by_miniority_dr.html"))
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_pred_by_female_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_test_by_female_dr.html"))
#-----------------------------------------------------------
###' c. - Minority & Female
#-----------------------------------------------------------
...
adj_values_tb %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_pred_by_minority_female_dr.html"))
...
data.frame(contrasts =
  ...
  gtsave(paste0("./05_Regression Tree Output/03 Race updated (August)/", out ,"/cau_test_by_minority_female_dr.html"))
