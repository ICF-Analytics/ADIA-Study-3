...
file_name <- paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/data/NLS.tree_", out, ".Rds")
dat <- readRDS(file_name)   # n=6281
dim(dat)  
...
#========================================================================
#classical Crime and Violence
#========================================================================

# - No combination of ACE and OCS for Crime and Violence classical tree

#========================================================================
# causal Crime and Violence
#========================================================================
#========================================================================
...
# Temp check
test <- dat %>% select(ace_ocs, new_w) %>% filter(ace_ocs == "ACE")
table('ace_ocs'=dat$ace_ocs, 'mother education'=dat$mhighgd_bin)
...
left_join(tb_r, tb_w, by = "var", suffix = c(".raw", ".weighted")) %>%
  ...
  gtsave(paste0("C:/Users/55231/OneDrive - ICF/Desktop/ADIA/output/", out, "/raw_weighted", out, i, ".html"))
...
### save file for subgroup analysis ###
file_name <- paste0("C:/Users/xxxxx/OneDrive - ICF/Desktop/ADIA/data/data_with_weights_", out, ".Rds")
