...
# - No combination of ACE and OCS for anxiety classical tree
...
data.frame(Contrast = tests,
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/test0_caus_", out, i, ".html"))
...
left_join(freq, data.frame(Group = grp, pred0, confint(pred0)), by = "Group") %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/pred0_caus_", out, i, ".html"))
...
data.frame(Contrast = tests,
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/test_dr_caus_", out, i, ".html"))
...
left_join(freq, data.frame(Group = grp, pred_dr, confint(pred_dr)), by = "Group") %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/pred_dr_caus_", out, i, ".html"))
...
data.frame(all) %>%
  ...
  gtsave(paste0("./05_Regression Tree Output/", out, "/supplemental_race_", out,".html"))
