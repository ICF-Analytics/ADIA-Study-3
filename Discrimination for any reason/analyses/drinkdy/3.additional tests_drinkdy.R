...
# - No combination of ACE and OCS for drinkdy classical tree
...
dat <-
  ...
  mutate(ace_ocs =
           case_when(
             anyACE_T == 1 & !(ecstand == 1) ~ "ACE"
             , anyACE_T == 1 &  (ecstand == 1) ~ "ACE + OCS"
             , anyACE_T == 0 &  (ecstand == 1) ~ "OCS"
             , anyACE_T == 0 & !(ecstand == 1) ~ "None"
           )
